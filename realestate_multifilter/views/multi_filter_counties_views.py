...
# -------------- Counties - MultiFilter - Second Flow -------------


class CountiesMultiFilter(APIView):
            ...
            if request.data:
                ...
                if topic_name_list[0] == "Race":
                    ...
                    if race_value > 0:
                        ...
                        for data in race_data:
                            ...
                            race_counties, error = TotalPercentage.top_counties_data(
                ...
                if topic_name_list[1] == "Income":
                    ...
                    if income_value > 0:
                        ...
                        for data in income_id_list:
                            ...
                            inc_state, error = TotalPercentage.top_counties_data(
                                IncomeEstimate, topic, data, count, filter_type
                            )
                ...
                if topic_name_list[2] == "Education":
                    ...
                    if edu_value > 0:
                        ...
                        edu_state, error = TotalPercentage.top_counties_data(
                ...
                if topic_name_list[3] == "Poverty":
                    ...
                    if pov_value > 0:
                        ...
                        pov_state, error = TotalPercentage.top_counties_data(
                            PovertyEstimate, topic, pov_id, count, filter_type
                        )
                ...
                if topic_name_list[4] == "Tenure":
                    ...
                    if ten_value > 0:
                        ...
                        for data in ten_data:
                            ...
                            ten_state, error = TotalPercentage.top_counties_data(
                                TenureEstimate, topic, tenure_id, count, filter_type)
                ...
                if topic_name_list[5] == "Mobility":
                    ...
                    if mob_value > 0:
                        ...
                        mob_state, error = TotalPercentage.top_counties_data(
                    ...
                    if age_value > 0:
                        ...
                        for age in age_data:
                            ...
                            for id in sub_a_id_list:
                                ...
                                age_state, error = TotalPercentage.top_counties_data(
                                    SexAgeEstimate, topic, age_id, count, filter_type
                                )
