...
# -------------- State - MultiFilter - Second Flow -------------


class StateMultiFilter(APIView):
    ...
    def post(self, request):
        ...
        try:
            if request.data:
                        ...
                        for data in race_data:
                            ...
                            if race_state.exists():
                                ...
                                for data in race_state:
                                    print(data.state.state_name)
                                    dic = {}
                                    dic[data.state.state_name] = sub_r_value/count
                ...
                if topic_name_list[1] == "Income":
                    ...
                    if income_value > 0:
                        ...
                        for data in income_id_list:
                            ...
                            inc_state, error = TotalPercentage.top_state_data(
                                IncomeStateTotal, topic, data, count, filter_type)
                            ...
                            if inc_state.exists():
                                ...
                                print('income_total_list: ', income_total_list)
                    ...
                    if edu_value > 0:
                        ...
                        if edu_state.exists():
                            for data in edu_state:
                                ...
                                dic = {}
                                dic[data.state.state_name] = edu_value/count
                ...
                if topic_name_list[3] == "Poverty":
                    ...
                    if pov_value > 0:
                        ...
                        pov_state, error = TotalPercentage.top_state_data(
                            PovertyStateTotal, topic, pov_id, count, filter_type
                        )
                        ...
                        if pov_state.exists():
                            ...
                            for data in pov_state:
                                dic = {}
                                dic[data.state.state_name] = pov_value/count
                ...
                if topic_name_list[4] == "Tenure":
                    ...
                    if ten_value > 0:
                        ...
                        for data in ten_data:
                            ...
                            ten_state, error = TotalPercentage.top_state_data(
                                TenureStateTotal, topic, tenure_id, count, filter_type)
                            ...
                            if ten_state.exists():
                                ...
                                for data in ten_state:
                                    ...
                                    dic[data.state.state_name] = sub_t_value/count
                    ...
                    if mob_value > 0:
                        ...
                        if mob_state.exists():
                            for data in mob_state:
                                ...
                                dic = {}
                                dic[data.state.state_name] = mob_value/count
                    ...
                    if age_value > 0:
                        ...
                        for age in age_data:
                            ...
                            for id in sub_a_id_list:
                                ...
                                age_state, error = TotalPercentage.top_state_data(
                                    SexAgeStateTotal, topic, age_id, count, filter_type
                                )
                                ...
                                if age_state.exists():
                                    ...
                                    for data in age_state:
                                        print("data", data.state.state_name)
                                        dic = {}
                                        dic[data.state.state_name] = age_id_value/count
                                        age_list.append(dic)
            ...
            return Response({'error in TSMF': f'{e}'})
